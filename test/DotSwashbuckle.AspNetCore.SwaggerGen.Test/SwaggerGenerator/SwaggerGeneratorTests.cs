...
namespace DotSwashbuckle.AspNetCore.SwaggerGen.Test
{
    public class SwaggerGeneratorTests
    {
        ...
        [InlineData("resources?param=value", "/resources")]
        ...
        public void GetSwagger_ThrowsSwaggerGeneratorException_IfActionHasNoHttpBinding()
        {
            ...
            Assert.Equal(
                "Ambiguous HTTP method for action - DotSwashbuckle.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (DotSwashbuckle.AspNetCore.SwaggerGen.Test). " +
        ...
        public void GetSwagger_ThrowsSwaggerGeneratorException_IfActionsHaveConflictingHttpMethodAndPath()
        {
            ...
            Assert.Equal(
                ...
                "DotSwashbuckle.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (DotSwashbuckle.AspNetCore.SwaggerGen.Test)," +
                "DotSwashbuckle.AspNetCore.SwaggerGen.Test.FakeController.ActionWithNoParameters (DotSwashbuckle.AspNetCore.SwaggerGen.Test). " +
